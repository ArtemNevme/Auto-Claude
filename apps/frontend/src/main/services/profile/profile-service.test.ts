...
describe('profile-service', () => {
  ...
  describe('updateProfile', () => {
    it('should update profile name and other fields', async () => {
      ...
      expect(result.models).toEqual({ default: 'claude-sonnet-4-6-20250929' });
  ...
  describe('discoverModels', () => {
    ...
    it('should return list of models for successful response', async () => {
      mockModelsList.mockResolvedValue({
        data: [
          { id: 'claude-sonnet-4-6-20250929', display_name: 'Claude Sonnet 4.6', created_at: '2024-10-22', type: 'model' },
